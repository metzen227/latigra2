...
public class Names
{
    ...
    {
        public static final String ATTUNEMENT_ROD = "attunementRod";
        public static final String KRYSTAL_SHARD_EMPTY = "krystalShardEmpty";
        public static final String KRYSTAL_CLUSTER = "krystalCluster";
    ...
    public static final class Krystal
    {
        ...
        public static final String KRYSTAL_SHIELD = "krystalShield";
        public static final String KRYSTAL_SPEED = "krystalSpeed";
        public static final String KRYSTAL_SUSTAIN = "krystalSustain";
        public static final String KRYSTAL_SHARPNESS = "krystalSharpness";
        public static final String KRYSTAL_KNOCKBACK = "krystalKnockback";
        public static final String KRYSTAL_LOOTING = "krystalLooting";
        public static final String KRYSTAL_BURNING = "krystalBurning";
        public static final String KRYSTAL_FREEZING = "krystalFreezing";
        public static final String KRYSTAL_EXPERIENCE = "krystalExperience";
        public static final String KRYSTAL_BLEEDING = "krystalBleeding";
        public static final String KRYSTAL_NIGHTEYE = "krystalNightEye";
        public static final String KRYSTAL_FEATHERFALL = "krystalFeatherFall";
        public static final String KRYSTAL_LIGHT = "krystalLight";
        public static final String KRYSTAL_REINFORCED = "krystalReinforced";
    ...
    {
        //public static final String ATTUNEMENT_ROD = "attunementRod";
        public static final String KRYSTAL_TOOLKIT = "krystalToolKit";
        public static final String KRYSTAL_MANIPULATOR = "krystalManipulator";
    }
